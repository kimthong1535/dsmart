...
{{--
    Template Name: Lãnh đạo qua các thời kỳ
--}}
            ...
            <div class="col-md-9">
                <div class="row">
                    ...
                    <div class="col-md-3 right-sidebar">
                        <h4 class="hot-news">TIN NỔI BẬT</h4>
                        @php
                            $right_sidebar = new WP_Query(array(
                                'post_type' => 'post',
                                'posts_per_page' => 6,
                                'post_status' => 'publish',
                                'orderby' => 'date',
                        ...
                        <div class="right-sidebar-item">
                            @php
                                if($right_sidebar->have_posts()) {
                                    @endphp <ul> @php
                                        while ($right_sidebar->have_posts()) {
                                            $right_sidebar->the_post();
                                            @endphp
                        ...
                        <h4 class="new-news">BÀI VIẾT MỚI NHẤT</h4>
                            @php
                                $right_sidebar = new WP_Query(array(
                                    'post_type' => 'post',
                                    'posts_per_page' => 6,
